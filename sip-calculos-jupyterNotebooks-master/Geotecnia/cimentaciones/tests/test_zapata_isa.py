...
class TestCalculosZapata(unittest.TestCase): 
    ...
    def test_calculo_capacidad_portante_suelos_granulares(self):
        ...
        q_ult, memoria = zapata.calculo_capacidad_portante_isa()
        print(memoria)
    ...
    def test_calculo_capacidad_portante_suelos_granulares5(self):
        ...
        q_ult, _ = zapata.calculo_capacidad_portante_isa()
    ...
    def test_calculo_capacidad_portante_suelos_cohesivos8(self):
        ...
        q_ult, memoria = zapata.calculo_capacidad_portante_isa()
        print(memoria)
        self.assertAlmostEqual(q_ult, 99.80, places=2) #159.79
        
    def test_calculo_carga_lateral1(self):
        zapata = copy.deepcopy(self.zapata_3)
        
        F_zc = 52.6
        Q_L, memoria = zapata.calculo_carga_lateral_isa(F_zc)
        #print(memoria)
    ...
    def test_calculo_carga_lateral6(self):
        ...
        Q_L, _ = zapata.calculo_carga_lateral_isa(F_zc)
    ...
    def test_calculo_carga_lateral7(self):
        ...
        Q_L, memoria = self.zapata_2.calculo_carga_lateral_isa(F_zc)
        print(memoria)
    ...
    def test_calculo_tension_cono_tierra_suelos_granulares(self):
        ...
        T_u, memoria = zapata.calculo_tension_isa(q_adm)
        print(memoria)
        self.assertAlmostEqual(T_u, 1070.46, places=2)
    ...
    def test_calculo_tension_cono_tierra_suelos_granulares2(self):
        ...
        T_u, memoria = zapata.calculo_tension_isa(q_adm)
        print(memoria)
        self.assertAlmostEqual(T_u, 695.78, places=2)
    ...
    def test_calculo_tension_cono_tierra_suelos_granulares3(self):
        ...
        T_u, memoria = zapata.calculo_tension_isa(q_adm)
        #print(memoria)
        self.assertAlmostEqual(T_u, 279.79, places=2)
    ...
    def test_calculo_tension_cono_tierra_suelos_granulares4(self):
        ...
        T_u, memoria = zapata.calculo_tension_isa(q_adm)
        #print(memoria)
        self.assertAlmostEqual(T_u, 336.73, places=2)
    ...
    def test_calculo_tension_cono_tierra_suelos_granulares5(self):
        ...
        T_u, memoria = zapata.calculo_tension_isa(q_adm)
        #print(memoria)
        self.assertAlmostEqual(T_u, 278.93, places=2)
    ...
    def test_calculo_tension_cono_tierra_suelos_granulares6(self):
        ...
        T_u, memoria = zapata.calculo_tension_isa(q_adm)
        #print(memoria)
        self.assertAlmostEqual(T_u, 202.69, places=2)
    ...
    def test_calculo_tension_cono_tierra_suelos_granulares7(self):
        ...
        T_u, memoria = zapata.calculo_tension_isa(q_adm)
        #print(memoria)
        self.assertAlmostEqual(T_u, 474.43, places=2)
    ...
    def test_calculo_tension_cono_tierra_suelos_granulares8(self):
        ...
        T_u, memoria = zapata.calculo_tension_isa(q_adm)
        print(memoria)
        self.assertAlmostEqual(T_u, 144.41, places=2)
    ...
    #     ], γ_r=γ_r, φ_r=φ_r))
    #     T_u, _ = zapata.calculo_tension_meyerhof_adams_suelos_cohesivos()
    ...
    def test_calculo_volcamiento(self):
        ...
        Mv, Me, memoria = zapata.calculo_volcamiento_isa(F_zc, F, T_u)
        #print(memoria)
    ...
    def test_calculo_momento_carga_lateral(self):
        ...
        M_o, memoria = zapata.calculo_carga_lateral_isa(F_c)
        #print(memoria)
