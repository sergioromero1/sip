...
class EvaluadorZapataDiseno():

    def __init__(self, evaluador: EvaluadorZapatas):
        self.evaluador = evaluador

    def evaluar(self, grupo, parametros: DBFila, torre: Torre, perfil: Perfil, info_cargas: Cargas, pausar_en_error: bool = True, usar_geom_grupo:bool = True ) -> Dict[Tuple[float,float], Dict[str, Tuple[float,float,bool]]]:
        """
        TODO
        Arguments:
        ...
        for HG in lista_HG:
            ...
            resultado = {"B": B, "D": D, "HG": HG, "TP": TP, "θ": θ, "α": α, "ω": ω, "error": False, "mensaje_error": None, "evaluacion": {}}  
            try:
                C = D + HG - H
