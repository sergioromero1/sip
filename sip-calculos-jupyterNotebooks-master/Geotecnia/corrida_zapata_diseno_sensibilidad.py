...
from cimentaciones.evaluador_zapata_diseno_sensibilidad import EvaluadorZapataDisenoSensibilidad
...
def main():
    ...
    comentario = f"Corrida de sensibilidad profundidad con datos de diseño (grupos de zapatas definidos) - Conjunto {conjunto}. Sensibilidad a {delta_z}m. Geometrías de {'estructuras' if usar_geom_grupo else 'geotecnia' }"
    ...
    evaluador_diseno = EvaluadorZapataDisenoSensibilidad(evaluador)
    ...
    for zapata_en_grupo in lista_zapatas_en_grupo:
        ...
        if error_en_perfil:
            ...
            # Evalúa
            resultados = evaluador_diseno.evaluar(zapata_en_grupo, delta_z, parametros, torre, perfil, info_cargas, pausar_en_error, usar_geom_grupo)
