...
def main():
    ...
    pocho = data_services.recuperar_mejor_grupo_micropilotes_3(torres_cubiertas,grupos_seleccionados,20)
    while pocho:
        ...
        if pocho["cobertura"] < 2:
            pocho = data_services.recuperar_mejor_grupo_micropilotes_3(torres_cubiertas,grupos_seleccionados,1000)
        elif pocho["cobertura"] < 5:
            pocho = data_services.recuperar_mejor_grupo_micropilotes_3(torres_cubiertas,grupos_seleccionados,60)
        else:
            pocho = data_services.recuperar_mejor_grupo_micropilotes_3(torres_cubiertas,grupos_seleccionados,30)
